---
description: Privacy policy for the Dango documentation site
---
...
This site is hosted on [Cloudflare Pages](https://pages.cloudflare.com/). Cloudflare may collect standard server log data (IP addresses, browser user agents, pages visited) as part of their infrastructure. See [Cloudflare's Privacy Policy](https://www.cloudflare.com/privacypolicy/) for details.
...
- **GitHub** ([github.com/getdango](https://github.com/getdango)) — source code and issue tracking
- **PyPI** ([pypi.org/project/getdango](https://pypi.org/project/getdango/)) — Python package registry
...
For privacy questions, open an issue on [GitHub](https://github.com/getdango/dango/issues).
